...
// GH #1126: switched from a manual renderApiTable/renderMarkdownBody append to the shared composeDocPage —
// slider.md now declares a `parts:` entry (the value readout), and composeDocPage is the ONE render path
// that also emits the Parts table (site-coverage.test.ts's standing gate: every parts-bearing descriptor's
// doc page must render one).
