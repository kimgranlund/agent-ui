...
describe('STRUCTURAL — S5-S9 (S5-S8 promoted at Phase 5, manifest M7-M10; S9 minted 2026-07-30)', () => {
  ...
  it('S8: ADR numbering contiguous modulo the KNOWN_GAPS allowlist', () => {
    ...
    // 209-219: reserved by the 2026-08-19 host-assigned catalog-design block — 209 (#1357 Disclosure
    // summary slot), 210 (#1360 FileDrop), 211 (#1364 Drill), 212 (#1367 RadioGroup depth discovery),
    // 213-219 held for the sibling design lanes (incl. 218 → #1374 Timeline plan-mode); this branch's
    // ADR-0220 (GH #1368 ChoiceGroup) was host-assigned 0220 past the block. Gaps inert as each lands.
