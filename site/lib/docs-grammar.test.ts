...
describe('STRUCTURAL — S5-S9 (S5-S8 promoted at Phase 5, manifest M7-M10; S9 minted 2026-07-30)', () => {
  ...
  it('S8: ADR numbering contiguous modulo the KNOWN_GAPS allowlist', () => {
    ...
    const KNOWN_GAPS = new Set([108, 151, 155, 173, 183, 188, 192, 193, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 221]) // 108/151/155/173/183/188 history · 192/193 reserved-in-flight (GH #959/#975) · 209-220 reserved-in-flight by the 2026-08-19 catalog-design lanes (PRs #1357/#1360/#1364/#1367/#1381/#1384/#1385; 215/218/221 RELEASED — permanent gaps, no PR will land them; 221 entered the Set when ADR-0222 landed and made it a mechanical gap) — inert once each lands
