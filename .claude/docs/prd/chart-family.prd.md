...
- Same-wave default-catalog rows (`Sparkline`, `BarChart`, `PieChart`) + the report-card exemplar seed (PRD-G3) — forced by the SPEC-N2 whole-fleet gate the moment the descriptors land.
