...
- [`../lld/a2a-a2ui-bridge.lld.md`](../lld/a2a-a2ui-bridge.lld.md) — the B6 LLD: the bridge mapping (HV-8 carriage + capabilities), the round-trip smoke, the recorded artifact-feed fixture + standing gate, and the artifact-feed demo page. *(landed 2026-07-08; closes the SPEC trace — no unspecced waves remain)*
