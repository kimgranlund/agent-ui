...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0212` utterance](https://github.com/kimgranlund/agent-ui/issues/1365#issuecomment-5343985487) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
