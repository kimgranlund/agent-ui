...
> | **Ratified by** | kimgranlund (repo owner), 2026-07-20, via the [`ratify ADR-0152` utterance](https://github.com/kimgranlund/agent-ui/pull/81#issuecomment-5022988292) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
