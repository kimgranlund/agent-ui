...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0208` utterance](https://github.com/kimgranlund/agent-ui/issues/1340#issuecomment-5337667209) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
