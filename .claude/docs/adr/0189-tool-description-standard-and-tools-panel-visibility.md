...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-14, via the [`ratify ADR-0189` utterance](https://github.com/kimgranlund/agent-ui/issues/847#issuecomment-5293111331) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
