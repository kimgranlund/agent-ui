...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-20, via the [`ratify ADR-0226` utterance](https://github.com/kimgranlund/agent-ui/issues/1504#issuecomment-5356582253) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
