...
> | **Ratified by** | Kim, 2026-07-11 — hand-flipped in-tree + confirmed at the ratification prompt; F2 (appended bullets in the "Output rules" section) and F5 (delete when done AND lingering would confuse; else keep as history) both as recommended |
