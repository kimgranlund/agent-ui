...
> | **Ratified by** | — (proposed; gate (iv) of the runtime-dependency-exception test is Kim's call ALONE — `scripts/adr_ratify.py` (ADR-0149) fills this cell on the `ratify ADR-0222` utterance) |
