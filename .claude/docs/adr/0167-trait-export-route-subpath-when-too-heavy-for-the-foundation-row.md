...
> | **Ratified by** | kimgranlund (repo owner), 2026-07-30, via the [`ratify ADR-0167` utterance](https://github.com/kimgranlund/agent-ui/pull/387#issuecomment-5136435804) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
