...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0220` utterance](https://github.com/kimgranlund/agent-ui/issues/1368#issuecomment-5343987116) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
