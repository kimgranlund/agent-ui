...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0224` utterance](https://github.com/kimgranlund/agent-ui/issues/1429#issuecomment-5347221720) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
