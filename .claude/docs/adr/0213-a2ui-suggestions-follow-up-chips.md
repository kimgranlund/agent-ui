...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0213` utterance](https://github.com/kimgranlund/agent-ui/issues/1369#issuecomment-5343985767) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
