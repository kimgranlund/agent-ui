...
> | **Ratified by** | *(pending — the Status flip is Kim's own edit, per the [ADR-0138](./0138-a2ui-producer-persona-seam.md) Status-flip-is-ratification precedent; F1–F5 carry firm recommendations that are the default absent an objection)* |
