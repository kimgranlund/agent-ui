...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-06, via the [`ratify ADR-0176` utterance](https://github.com/kimgranlund/agent-ui/pull/506#issuecomment-5208653369) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
