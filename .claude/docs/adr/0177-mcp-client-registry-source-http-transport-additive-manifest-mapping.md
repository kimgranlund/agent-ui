...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-06, via the [`ratify ADR-0177` utterance](https://github.com/kimgranlund/agent-ui/pull/507#issuecomment-5208652418) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
