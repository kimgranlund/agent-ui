...
> | **Ratified by** | kimgranlund (repo owner), 2026-08-19, via the [`ratify ADR-0209` utterance](https://github.com/kimgranlund/agent-ui/issues/1351#issuecomment-5343984630) — verified + flipped by `scripts/adr_ratify.py` (ADR-0149) |
