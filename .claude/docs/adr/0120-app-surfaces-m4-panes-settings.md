...
> | **Repairs** | [`../prd/agent-app-surfaces.prd.md`](../prd/agent-app-surfaces.prd.md) → v1.2 (v1.1 added PRD-G7/PRD-G8 + milestone M4 + scope rows; the ratification fork pass then widened M4 to **v1.2** — `ui-split` multi-pane + the settings schema framework; the ratified v1.0 decisions PRD-D1–D6 are untouched. *Cell marker corrected 2026-07-10 `v1.1`→`v1.2` — a factual reference fix tracking the PRD's landed version, NOT a decision edit to this accepted ADR.*) |
> | **Supersedes / Superseded by** | (none) — relates [ADR-0084](./0084-app-shell-narrow-reflow-collapse.md) (whose RESERVED `collapse: "toggle"` value M4 realizes) · [ADR-0082](./0082-app-shell-per-instance-isolation.md)/[ADR-0083](./0083-app-shell-region-role-decouple.md) (the shell contract M4 composes) · [ADR-0115](./0115-spa-router-v1-scope.md) (router stays catalog- and app-invisible — settings navigation wiring is consumer business) · [ADR-0040](./0040-foundation-barrel-budget-7kb.md)/[ADR-0049](./0049-family-barrel-budget-22kb.md) (the budget re-base discipline the `ui-split` addition will follow) |
