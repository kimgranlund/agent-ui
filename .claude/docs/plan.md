...
7659 B gz against 7680 on 2026-08-16, 21 B headroom); the self-defining `ui-*` family barrel ≤ 56 KB (the
...
measured 56718 B gz); per-control marginal ≤ ~1.5–2 kB; a keep-all library ratchet that
