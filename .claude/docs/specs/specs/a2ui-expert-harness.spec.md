...
- **Agent** — a subagent that *makes* an A2UI artifact in an isolated context, authored via `agent-author`.
- **Rubric** — a referential scoring standard, authored via `rubric-author`; the thing judgment checks against.
...
**SPEC-R7 — Authored-via-harness + governance.** Every skill/agent/rubric MUST be authored with the corresponding authoring skill (`skill-author` / `agent-author` / `rubric-author`) and score ≥ its rubric bar; every artifact MUST obey `process.md` placement (deterministic→script/hook; judgment→rubric; procedure→skill). *(→ PRD-G3; Constraint C3)*
...
|---|---|---|---|---|
| `a2ui-component-patterns` | skill | skill-author | skills rubric | SPEC-R1a |
| `a2ui-composition` | skill | skill-author | skills rubric | SPEC-R1b |
| `a2ui-jsonl-mcp` | skill | skill-author | skills rubric | SPEC-R1c |
| `a2ui-corpus-authoring` | skill | skill-author | skills rubric | SPEC-R1d |
| `a2ui-catalog-author` | agent | agent-author | catalog-quality rubric | SPEC-R2 |
| `a2ui-payload-composer` | agent | agent-author | a2ui-payload-quality rubric | SPEC-R2 |
| `a2ui-corpus-curator` | agent | agent-author | corpus-quality rubric | SPEC-R2 |
| `a2ui-payload-quality` | rubric | rubric-author | rubric-for-rubrics | SPEC-R3 |
| `catalog-quality` | rubric | rubric-author | rubric-for-rubrics | SPEC-R3 |
| `corpus-quality` | rubric | rubric-author | rubric-for-rubrics | SPEC-R3 |
