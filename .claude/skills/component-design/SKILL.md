...
Load the map skills as you go: [[component-standards]] (law),
[[component-patterns]] (prior art), [[component-packaging]] (shape),
[[component-testing]] (the bar the test plan must meet).
...
2. **Dedup + precedent sweep.** Is it a variant/prop of an existing control rather than a new
   ...
   **SOURCE of every trait/mechanism you plan to reuse** — a trait's real signature (value vs
   ...
   sweep the [[component-patterns]] table — every mechanism the design needs that a
...
7. **Decompose + test plan.** A decomposition (break-down-problem where installed;
   ...
   [[component-testing]] bar — including a built-output leg whenever the design
