...
reach for each is [[app-composition]]'s territory.

## Cross-links

Assembly mechanics (forms, box-model, overlays, theming) → [[composition-patterns]]
· compose procedures → [[ui-composition]] / [[layout-composition]] /
[[app-composition]] · building a MISSING control → [[component-design]].
