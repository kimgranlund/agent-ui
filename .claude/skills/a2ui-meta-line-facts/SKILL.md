...
description: >-
  ...
  producer's PROMPT STACK (a2ui-prompt-authoring); NOT for composing A2UI payloads (a2ui-payload-authoring).
...
files (`a2ui-prompt-authoring`) or payloads (`a2ui-payload-authoring`).
