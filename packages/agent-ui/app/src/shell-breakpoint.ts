...
// family's narrow-collapse threshold, shared by master-detail.css, nav-rail.css, and super-shell.css
// (the app-shell.css/app-shell-isolation.css sites retired with the component, ADR-0156).
//
...
// genuinely cannot drive the three sites' `@container (inline-size < 40rem)` rules. Each site therefore
