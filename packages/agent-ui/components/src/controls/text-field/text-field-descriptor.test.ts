...
// ADR-0223 (Fill by Default, slice-0 pilot): `inline` added after `readonly` — the ONE sizing opt-out boolean.
const ATTR_NAMES = ['value', 'label', 'placeholder', 'size', 'type', 'readonly', 'inline', 'currency', 'unit', 'step', 'min', 'max', 'format', 'name', 'disabled', 'required']
