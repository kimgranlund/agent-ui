...
// ui-choice-group drives roving + commit). The whole-shape geometry + forced-colors + non-color
// signifier proofs now live in the real `choice-card.browser.test.ts` shard (the GH #1398 blocking
// precondition — SHIPPED, not deferred).
//
