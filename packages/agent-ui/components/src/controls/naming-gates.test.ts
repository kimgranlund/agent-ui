...
const ALLOWED_ROLES = new Set([
  ...
  // ui-timeline-item's recursive-nesting slot (ADR-0143 F1/TKT-0091) — a pre-existing <ui-timeline>
  // light-DOM child adopted alongside 'detail' into the SAME composed disclosure. Added in the SAME
  // change as naming.md §6's registry line.
  'nested',
])
