...
describe('ICON_NAMES', () => {
  it('has exactly ninety names (32 pre-ADR-0169 + 44 ADR-0169 cl.9b Icon-table members + 3 ADR-0179 GH #686 Amendment S7-a members + 2 GH #868 composer-trigger glyphs + 8 GH #1258 weather glyphs + 1 GH #1406 minus stepper glyph)', () => {
    expect(ICON_NAMES.length).toBe(90)
  })
