...
describe('ICON_NAMES', () => {
  it('has exactly eighty-nine names (32 pre-ADR-0169 + 44 ADR-0169 cl.9b Icon-table members + 3 ADR-0179 GH #686 Amendment S7-a members + 2 GH #868 composer-trigger glyphs + 8 GH #1258 weather glyphs)', () => {
    expect(ICON_NAMES.length).toBe(89)
  })
