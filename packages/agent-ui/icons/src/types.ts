...
export const ICON_NAMES = [
  ...
  'dots-three', // GH #168 — the fleet's one horizontal overflow/more-actions glyph (originally the site's agent-admin canvas-header page-actions ui-menu trigger, retired S7-d GH #684/#701; live consumers today incl. `ui-agent-admin`'s own narrow-header overflow-menu trigger and ui-tabs's overflow trigger — replacing a glued "…" text node, the TKT-0048 anti-pattern). Phosphor's catalog has no `dots-three-horizontal`; `dots-three` IS the horizontal one, and its regular-weight dots match the pack's line weight where `dots-three-outline`'s donut dots would read heavier than every neighbor glyph.
