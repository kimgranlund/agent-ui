...
| **LLD-C10** | Client-side function evaluator + `${…}` interpolator | SPEC-R10 | `functions.ts` · `interpolate.ts` (ADR-0027) · `fn-expr.ts` (ADR-0028 function-expression parser) |
