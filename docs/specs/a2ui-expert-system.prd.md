...
- **C4 — Documents are authored via the spec family.** PRD → SPEC → LLD, authored with `authoring-prds/specs/llds`; reference-by-ID, not duplication; traceability is a CI check.
