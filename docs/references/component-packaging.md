...
> authoring procedure is the `authoring-components` skill, which points here. Distilled 2026-06-27.
...
- `authoring-components` (skill) — the procedure that *produces* this shape; points here for the layout.
