...
> | **Proposed by** | planning-lead — the design seat, on the control-suite foundation (#49 Wave 0); details in `docs/llds/overlay-controller.lld.md` + `listbox-roving.lld.md` |
