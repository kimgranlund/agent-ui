...
14. **`docs/specs/specs/a2ui-catalog.spec.md`** — the `Modal` row (line ~136): `dismissable` → `persistent`.
15. **`docs/specs/llds/a2ui-catalog.lld.md`** — the `mapsTo` 1:1 list (line ~80): `selected`/`open`/**`dismissable`**/`scroll`
    → …/**`persistent`**/`scroll`.
16. **`docs/decompositions/g9-containers.decomp.json`** — the `s9` acceptance text (line ~54):
...
**E. ADR cross-references** — `docs/adr/` *(authored in this wave by planning-lead)*
