...
> | **Repairs** | `controls/text-field/text-field.css` (the `type=password` editor: `-webkit-text-security: disc`; the reveal toggle flips it) + `text-field.md` (the caveat) · `docs/decompositions/control-suite-wave3-input-variants.decomp.md` (S-B) · **Relates ADR-0014** (the contenteditable-surface choice this handles a consequence of). |
