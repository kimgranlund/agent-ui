...
| [0009](./0009-focus-ring-token-standard.md) | The shared focus-ring standard (`--c-focus-ring` + `:focus-visible` outline) | accepted | NEW shared tokens.css `--c-focus-ring` · shared dimensions.css `--ui-focus-ring-*` · button.css · goals §G5 |
