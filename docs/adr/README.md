...
| [0024](./0024-a2ui-v1-positional-dynamic-list.md) | A2UI v1.0 dynamic lists are positional (index-based, no key); `list.ts` uses a bespoke positional reconcile, not `repeat` | proposed | a2ui-renderer LLD-C6 §5 + kernel-reuse note · NEW a2ui/protocol.ts ChildList union · NEW a2ui/renderer/list.ts · relates ADR-0022/0023 · user-ratified B2 |
